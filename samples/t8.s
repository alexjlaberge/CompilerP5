  ...
  _Vegetable.Eat:
	# BeginFunc 40
	  ...
	  lw $t4, 8($fp)	# fill veg to $t4 from $fp+8
	...
	# LCall _PrintString
	  ...
	  sw $t4, 8($fp)	# spill veg from $t4 to $fp+8
	  sw $t3, -8($fp)	# spill s from $t3 to $fp-8
  ...
  main:
	...
	# LCall _PrintString
	  ...
	  jal _PrintString   	# jump to function
	  lw $t2, -12($fp)	# fill _tmp16 to $t2 from $fp-12
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# LCall _Halt
	  sw $t2, -12($fp)	# spill _tmp16 from $t2 to $fp-12
  ...
  _L0:
	...
	# PushParam _tmp33
	  ...
	  sw $t0, 4($sp)	# copy param value to stack
	# LCall _PrintString
	  sw $t5, -8($fp)	# spill veggies from $t5 to $fp-8
	  sw $t3, -52($fp)	# spill _tmp26 from $t3 to $fp-52
	  jal _PrintString   	# jump to function
	  lw $t5, -8($fp)	# fill veggies to $t5 from $fp-8
  ...
  _L1:
	...
	# LCall _PrintString
	  ...
	  jal _PrintString   	# jump to function
	  lw $t5, -8($fp)	# fill veggies to $t5 from $fp-8
	  lw $t3, -108($fp)	# fill _tmp40 to $t3 from $fp-108
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# LCall _Halt
	  sw $t5, -8($fp)	# spill veggies from $t5 to $fp-8
  ...
  _L3:
	...
	# LCall _PrintString
	  ...
	  sw $t3, -216($fp)	# spill _tmp67 from $t3 to $fp-216
	  jal _PrintString   	# jump to function
	  lw $t5, -8($fp)	# fill veggies to $t5 from $fp-8
	  lw $t4, -212($fp)	# fill _tmp66 to $t4 from $fp-212
	  lw $t3, -216($fp)	# fill _tmp67 to $t3 from $fp-216
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# LCall _Halt
	  sw $t5, -8($fp)	# spill veggies from $t5 to $fp-8
